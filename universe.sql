...
CREATE TABLE public.lifeform (
    name character varying(30) NOT NULL,
    lifeform_id integer DEFAULT nextval('public.lifeforms_lifeform_id_seq'::regclass) NOT NULL,
    lifespan integer
);
...
SELECT pg_catalog.setval('public.lifeforms_lifeform_id_seq', 1, false);
...
--
-- Name: lifeform lifeform_name_uk; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.lifeform
    ADD CONSTRAINT lifeform_name_uk UNIQUE (name);


--
-- Name: lifeform lifeforms_pk; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.lifeform
    ADD CONSTRAINT lifeforms_pk PRIMARY KEY (lifeform_id);


--
-- Name: moon moon_name_uk; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.moon
    ADD CONSTRAINT moon_name_uk UNIQUE (name);
...
--
-- Name: planet planet_name_uk; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.planet
    ADD CONSTRAINT planet_name_uk UNIQUE (name);
